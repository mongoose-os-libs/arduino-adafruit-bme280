...
let Adafruit_BME280 = {
  ...
  _proto: {
    // ## **`myBME.begin()`**
    // Initialize the sensor with the parameters given to `create...` function.
    // Return value: 1 if succeed, 0 otherwise.
    begin: function() {
      return Adafruit_BME280._begin(this.bme, this.i2cad);
    },
